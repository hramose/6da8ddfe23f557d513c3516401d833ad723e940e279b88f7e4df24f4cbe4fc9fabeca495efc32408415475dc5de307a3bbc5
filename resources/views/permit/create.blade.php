...
@section('content')
  ...
  <form class="form-horizontal" role="form" method="POST" action="{{ url('/permits/create') }}">
    {!! csrf_field() !!}
    ...
    <div class="form-group{{ $errors->has('per_strAbrebiatura') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="per_strAbrebiatura" value="{{ old('per_strAbrebiatura') }}">
    ...
    <div class="form-group{{ $errors->has('per_strNombre') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="per_strNombre" value="{{ old('per_strNombre') }}">
    ...
    <div class="form-group{{ $errors->has('per_strDescripcion') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <textarea class="form-control" name="per_strDescripcion" value="{{ old('per_strDescripcion') }}"></textarea>
