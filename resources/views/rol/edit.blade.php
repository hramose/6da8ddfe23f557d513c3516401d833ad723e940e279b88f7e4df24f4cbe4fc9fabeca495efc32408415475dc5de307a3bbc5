...
@section('content')
  ...
  <form class="form-horizontal" role="form" method="POST" action="{{ url('/rols/edit', $rol->rol_intId) }}">
    {!! csrf_field() !!}
    ...
    <div class="form-group{{ $errors->has('rol_strAbrebiatura') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="rol_strAbrebiatura" value="{{ $rol->rol_strAbrebiatura }}">
    ...
    <div class="form-group{{ $errors->has('rol_strNombre') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="rol_strNombre" value="{{ $rol->rol_strNombre }}">
    ...
    <div class="form-group{{ $errors->has('rol_strDescripcion') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <textarea class="form-control" name="rol_strDescripcion">
              {{ $rol->rol_strDescripcion }}
            </textarea>
